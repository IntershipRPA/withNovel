<template>
  <NodeViewWrapper>
    <div class="block flex items-end">
      ...
      <span class="recipe-btn-setting recipe-tail cursor-pointer rounded-r-lg shadow-md bg-green-400 hover:bg-green-500 z-10 h-10 px-6 pl-7 my-2 text-sm text-white -ml-4 flex items-center min-w-max">
        레시피
      </span>
    </div>
    <div>
