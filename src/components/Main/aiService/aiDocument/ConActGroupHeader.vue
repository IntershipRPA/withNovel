<template>
  <div class="relative flex my-4 justify-center">
    <div class="absolute flex justify-center -mt-3 bg-gray-300 w-full rounded-lg">액션을 실행시키기 위한 조건 그룹{{ props.groupKey }}</div>
